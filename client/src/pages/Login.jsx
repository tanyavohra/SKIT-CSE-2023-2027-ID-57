...
export default function Login() {
  ...
  const { login } = useAuth(); // expects login(email, password) -> Promise
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="block text-sm font-semibold text-[#0b1c30]" htmlFor="password">
                  Password
                </label>
                <Link to="/forgot-password" className="text-xs font-semibold text-[#0051d5] hover:underline">
                  Forgot password?
                </Link>
              </div>
              <div className="relative rounded-xl">
            ...
            <div className="flex items-center justify-between pt-1">
              <label className="flex items-center gap-2 cursor-pointer select-none">
                <input
                  ...
                  className="w-4 h-4 rounded text-[#0051d5] border-[#c6c6cd] focus:ring-[#0051d5]/30"
                />
                <span className="text-sm text-[#45464d]">Remember me for 30 days</span>
              </label>
            </div>
